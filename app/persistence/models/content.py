...
class SourceItem(Base):
    ...
    answer_document: Mapped[AnswerDocument | None] = relationship(
        "AnswerDocument", back_populates="source_item", uselist=False
    )
...
class ChatSourceItem(Base):
    ...
    # 关系
    chat: Mapped[Chat] = relationship("Chat", back_populates="chat_source_items")
...
if TYPE_CHECKING:
    ...
    from .documents import AnswerDocument
