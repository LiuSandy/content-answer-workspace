...
from app.modules.knowledge.domain.models import KnowledgeDocumentStatus, SourceType, KnowledgeScope
...
from app.modules.knowledge.application.trace_service import TraceService
from app.modules.knowledge.adapters.db.storage import KnowledgeStorage
from app.platform.files.ssrf import SSRFError, fetch_url_safely
from app.platform.files.parsers import HtmlCleanerParser, MinerUCloudParser, ParsedMarkdown
from app.platform.config.runtime import get_knowledge_settings, is_truthy
...
from app.modules.knowledge.adapters.db.models import KnowledgeIngestionJobModel, KnowledgeSourceFileModel
...
async def test_knowledge_retrieval(
    ...
    from app.modules.knowledge.application.retrieval_service import KnowledgeRetrievalService, RetrievalRequest
