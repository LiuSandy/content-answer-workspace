...
from app.modules.writing.application.planning import (
...
async def _to_plan(plan_row, subs) -> TaskPlan:
    from app.modules.writing.application.planning import SubTask as _Sub
    tasks = [
...
async def stream_task_plan(plan_id: str, req: CreateTaskPlanRequest = Body(default=None)):  # type: ignore
    ...
    async def _gen():
        ...
        try:
            ...
            from app.modules.writing.application.planning import topological_order
...
async def _run_one_no_yield(sub_task, plan_id: uuid.UUID, results: dict):
    ...
    from app.modules.writing.application.planning import execute_subtask
    factory = get_session_factory()
