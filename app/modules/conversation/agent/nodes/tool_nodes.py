...
from app.shared.dto import AgentError, ChatResponsePayload, ParseUrlRequest, ToolContext, ToolResult
...
async def parse_url_node(state: ChatAgentState) -> dict:
    ...
    from app.plugins.sources.registry import source_registry
