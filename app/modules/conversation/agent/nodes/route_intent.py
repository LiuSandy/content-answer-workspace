...
from app.shared.dto import IntentRoute
from app.shared.llm.dto import LLMMessage, StructuredLLMRequest
...
async def _detect_intent(state: ChatAgentState) -> dict:
    ...
    try:
        ...
        structured = await _get_intent_gateway().generate_structured(
            purpose="conversation.intent_route",
