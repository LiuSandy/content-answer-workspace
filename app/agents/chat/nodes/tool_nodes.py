...
from app.contracts.dto import AgentError, ChatResponsePayload, ParseUrlRequest, ToolContext, ToolResult
...
async def parse_url_node(state: ChatAgentState) -> dict:
    ...
    from app.infrastructure.collectors.sources.registry import source_registry
